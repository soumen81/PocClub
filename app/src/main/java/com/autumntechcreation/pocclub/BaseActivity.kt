...
import com.autumntechcreation.pocclub.di.component.Injectable
import com.autumntechcreation.pocclub.util.Constantss
import com.autumntechcreation.pocclub.util.FragmentAnimation
import com.autumntechcreation.pocclub.util.Utility
...
//        }
    ...
    fun exceptionDialog(msg: String) {
        ...
        Utility.showSnackBarInternet(this@BaseActivity, window.decorView.rootView, msg)
    ...
    override fun onClick(v: View) {
        Utility.hideSoftKeyBoard(this@BaseActivity, v)

        /*
         * Logic to Prevent the Launch of the Fragment Twice if User makes
         * the Tap(Click) very Fast.
         */
        if (SystemClock.elapsedRealtime() - lastClickedTime < Constantss.MAX_CLICK_INTERVAL) {
